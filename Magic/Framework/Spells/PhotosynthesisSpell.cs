        ...
        *********/
        ...
        public override IActiveEffect OnCast(Farmer player, int level, int targetX, int targetY)
        {
            ...
            foreach (GameLocation location in Game1.locations
                .Concat(
                    from location in Game1.locations.Where(location => location.IsBuildableLocation())
                ...
                foreach (var terrainFeature in loc.terrainFeatures.Values)
                {
                    switch (terrainFeature)
                    {
                        ...
                        case FruitTree tree:
                            ...
                            else if (!tree.stump.Value && tree.growthStage.Value == 4 && tree.IsInSeasonHere())
                            {
            ...
            player.netItems.Value.ReduceId(SObject.prismaticShardID, 1);
            return null;
        }
