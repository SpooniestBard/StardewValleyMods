    ...
    internal class BloodManaSpell : Spell
    {
        ...
        *********/
        ...
        public override IActiveEffect OnCast(Farmer player, int level, int targetX, int targetY)
        {
            ...
            player.currentLocation.debris.Add(new Debris(health, new Vector2(player.Tile.X + 8, player.Tile.Y), Color.Red, 1f, player));
            ...
            player.AddMana(mana);
            player.currentLocation.debris.Add(new Debris(mana, new Vector2(player.Tile.X + 8, player.Tile.Y), Color.Blue, 1f, player));
